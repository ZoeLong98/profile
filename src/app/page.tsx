...
export default function PersonalInformation() {
  ...
  return (
    <div className="bg-gray-100 flex flex-col items-center justify-center h-screen">
      ...
      <p className={`${Inria.className} my-2`}>Hello World!</p>
      ...
      <div className="flex justify-between w-40">
        {isAboutVisible && (
          <div
            className={`${Inria.className} absolute border-4 border-black translate-x-[-150px] translate-y-[-50px] px-5 py-3 rounded-lg`}
          >
            <b>My position</b>
            <p>front end</p>
          </div>
